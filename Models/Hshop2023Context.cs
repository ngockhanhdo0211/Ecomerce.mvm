...
public partial class Hshop2023Context : DbContext
{
    ...
    //warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-TD5D3G6V;Initial Catalog=Hshop2023;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaCtdh).HasName("PK__ChiTietD__1E4E40F0D6BB0213");
            ...
            entity.HasOne(d => d.MaDhNavigation).WithMany(p => p.ChiTietDonHangs)
                ...
                .HasConstraintName("FK__ChiTietDon__MaDH__19DFD96B");

            entity.HasOne(d => d.MaHhNavigation).WithMany(p => p.ChiTietDonHangs)
                .HasForeignKey(d => d.MaHh)
                .HasConstraintName("FK__ChiTietDon__MaHH__1AD3FDA4");
        });
        ...
        {
            entity.HasKey(e => e.MaDh).HasName("PK__DonHang__27258661E85C9C61");
